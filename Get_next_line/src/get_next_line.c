...
/* 1.Reads either n-bytes defined  by BUFFER_SIZE or less when encountering '\n'.
*  2. Stocks the portion read in the local buffer ending wth '\0'.
*  3. Before the buffer is rewritten, the portion is added to static list stash
 */
...
/* Extracts all characters from our stash before '\n' and stores them in our line.*/
